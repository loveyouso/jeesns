...
<body>
<div class="mianBox">
    <img src="${basePath}/static/res/common/images/yun0.png" alt="" class="yun yun0" />
    <img src="${basePath}/static/res/common/images/yun1.png" alt="" class="yun yun1" />
    <img src="${basePath}/static/res/common/images/yun2.png" alt="" class="yun yun2" />
    <img src="${basePath}/static/res/common/images/bird.png" alt="" class="bird" />
    <img src="${basePath}/static/res/common/images/san.png" alt="" class="san" />
    <div class="tipInfo">
        <div class="in">
            <div class="textThis">
                <h2>
