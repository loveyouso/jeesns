...
<head>
    ...
    <script src="${basePath}/static/res/common/js/jquery.masonry.min.js"></script>
    <script src="${basePath}/static/res/common/js/jqeasing.js"></script>
    <script src="${basePath}/static/res/front/js/jeesns.js"></script>
    <script src="${basePath}/static/res/front/js/picture.js"></script>
</head>
