    ...
    <div id="banner" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img alt="First slide" src="${basePath}/static/res/front/images/banner1.png">
            ...
            <div class="item">
                <img alt="Second slide" src="${basePath}/static/res/front/images/banner2.png">
                <div class="carousel-caption">
                    <h3></h3>
                    <p></p>
                </div>
            ...
            <div class="item">
                <img alt="Third slide" src="${basePath}/static/res/front/images/banner3.png">
                <div class="carousel-caption">
                    <h3></h3>
                    <p></p>
                </div>
