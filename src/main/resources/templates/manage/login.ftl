...
<head>
    ...
    <link href="/static/res/manage/css/effect.css" rel="stylesheet">
    <link href="/static/res/plugins/layer/skin/layer.css" rel="stylesheet">
    <script src="/static/res/common/js/jquery-2.1.1.min.js"></script>
    <script src="/static/res/common/js/jquery.form.js"></script>
    <script src="/static/res/common/js/bootstrap.min.js"></script>
    <script src="/static/res/manage/js/app.js"></script>
    <script src="/static/res/plugins/layer/layer.js"></script>
    <script src='/static/res/manage/js/jquery-ui.min.js'></script>
    <script src='/static/res/manage/js/stopExecutionOnTimeout.js'></script>
    <script src="/static/res/manage/js/Particleground.js"></script>
    <script src="/static/res/manage/js/jquery.mockjax.js"></script>
</head>
<body>
<div class='login'>
    ...
    <div class='login_fields'>
        <div class='login_fields_user'>
            <div class='icon'>
                <img alt="" src='/static/res/manage/images/user_icon_copy.png'>
            </div>
            <input name="name" placeholder='用户名' maxlength="32" type='text' autocomplete="off"/>
            <div class='validation'>
                <img alt="" src='/static/res/manage/images/tick.png'>
            </div>
        </div>
        <div class='login_fields_password'>
            <div class='icon'>
                <img alt="" src='/static/res/manage/images/lock_icon_copy.png'>
            </div>
