...
<head>
    ...
    <link rel="stylesheet" href="${basePath}/static/res/common/css/jeesns.css">
    <link rel="stylesheet" href="${basePath}/static/res/common/css/jeesns-skin.css">
    <!--[if lt IE 9]>
    ...
    <script src="${basePath}/static/res/plugins/metisMenu/metisMenu.js"></script>
    <script src="${basePath}/static/res/plugins/slimscroll/jquery.slimscroll.min.js"></script>
    <script src="${basePath}/static/res/plugins/layer/layer.js"></script>
    <script src="${basePath}/static/res/common/js/manage.js"></script>
    <script src="${basePath}/static/res/plugins/fullAvatarEditor/scripts/fullswfobject.js"></script>
    <script src="${basePath}/static/res/plugins/fullAvatarEditor/scripts/fullAvatar.js"></script>
</head>
