...
import com.sm.jeesns.core.annotation.After;
import com.sm.jeesns.core.annotation.Before;
import com.sm.jeesns.core.annotation.Clear;
...
public class InitInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        IMessageService messageService = SpringContextHolderUtil.getBean("messageService");
